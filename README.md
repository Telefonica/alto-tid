...
### General Description
This code is an ALTO's special implementation used by TID in different european and Mineco projects.
...
This branch is designed to be used alongside ExaBGP. It reads the logs generated by ExaBGP to build the network topology.

The main differences between this branch and the others are that it uses queues instead of sockets, and it resolves several issues present in previous versions—such as the inability to read ExaBGP logs correctly.
