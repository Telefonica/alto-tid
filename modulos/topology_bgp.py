...
from modulos.bgp.bgp_simulator import BGPSimulator

DEFAULT_ASN = 0
RR_BGP_0 = "50.50.50.1"
#RR_BGP = BGP_INFO['bgp']['ip']

NODOS = ["10.10.10.1", "10.10.10.2", "10.10.10.3", "10.10.10.4", "10.10.10.5", "10.10.10.6", "10.10.10.7", "10.10.10.8"]
LINKS = [("10.10.10.1", "10.10.10.5", 10), 
            ("10.10.10.1", "10.10.10.3", 15), 
            ("10.10.10.5", "10.10.10.2", 20),
            ("10.10.10.2", "10.10.10.4", 10), 
            ("10.10.10.3", "10.10.10.6", 15), 
            ("10.10.10.3", "10.10.10.4", 20), 
            ("10.10.10.6", "10.10.10.7", 10), 
            ("10.10.10.7", "10.10.10.8", 15),  
            ("10.10.10.4", "10.10.10.8", 25)]
    ...
    def manage_topology_updates(self):
        ...
        while True:
            ...
            if b'decoded UPDATE' in line and b'json' in line:
                ...
                if 'announce' in update_msg:
                    ...
                    for route in update_msg['withdraw']['bgp-ls bgp-ls']:
                        ...
                        for field, values in route.items():
                            ...
                            if u != 0 and v != 0:
                                try:
                                    self.remove_edge(self.split_router_ids(u), self.split_router_ids(v))
                                except:
                ...
                data = {"pids":datos,"nodes-list":self.nodos,"costs-list": z_ejes,"prefixes": self.pids}
